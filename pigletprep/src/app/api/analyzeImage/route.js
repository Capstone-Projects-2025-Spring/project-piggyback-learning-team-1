...
//     // Add the required format
//     promptText += "\n Respond with this format only after the colon here: Insert e, A) Choice A B) Choice B C) Choice C D) Choice D CorrAswer: Correct Answer Here Hint: Hint Here";
